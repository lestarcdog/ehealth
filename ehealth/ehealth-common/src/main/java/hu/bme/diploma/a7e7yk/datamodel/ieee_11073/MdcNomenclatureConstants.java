/*
 * Copyright (C) 2008-2009 Santiago Carot Nemesio email: scarot@libresoft.es
 * 
 * This program is a (FLOS) free libre and open source implementation of a multiplatform manager
 * device written in java according to the ISO/IEEE 11073-20601. Manager application is designed to
 * work in DalvikVM over android platform.
 * 
 ...
 * this standard. They are either copied from ISO/IEEE 11073-10101 or created for this standard and
 * incorporated into ISO/IEEE 11073-10101. The format used here follows the one defined in ISO/IEEE
 * 11073-10101.
 *************************************************************************************************/
public interface MdcNomenclatureConstants {
  ...
  /*
   * Placed 256 back from the start of the last Partition: OptionalPackageIdentifiers (i.e.,
   * 8192-256).
   */
  ...
  public static final int MDC_RET_CODE_OBJ_BUSY = 1000; /*
                                                         * Object is busy so cannot handle the
                                                         * request
                                                         */
