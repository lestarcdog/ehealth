...
public class GlucoseMeasurement extends AbstractMeasurement<GlucoseVitalSign> {
  ...
  protected void generateMeasurementOBXs() throws DataTypeException {
    ...
    if (value.getGlucose().getValue() != null) {
      obx = builder.provideOBX();
      ...
      MeasurementHelper.setObxField5NMTypeValue(obx, builder.getHL7Message(), value.getGlucose().getValue());
